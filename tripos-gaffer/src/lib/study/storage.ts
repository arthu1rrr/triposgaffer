import { isValidCourseId, isValidLectureId, isValidModuleId } from '@/lib/catalog';
import type { LectureId, ModuleId } from '../catalog/types';
...
function reconcileWithCatalog(state: StudyStateV2): StudyStateV2 {
  //removes invalid ids when catalog changes
