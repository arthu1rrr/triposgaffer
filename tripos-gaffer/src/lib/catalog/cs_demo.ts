...
export const DEMO_MODULES: ModuleDefinition[] = [
  {
    ...
    name: 'Algorithms',
    lectureIds: ['cs-tripos-demo-2025-algorithms-01', 'cs-tripos-demo-2025-algorithms-02'],
  },
  {
    id: 'cs-tripos-demo-2025-oop',
    courseId: DEMO_COURSE.id,
    name: 'Object-Oriented Programming',
    lectureIds: ['cs-tripos-demo-2025-oop-01', 'cs-tripos-demo-2025-oop-02'],
  },
  {
    id: 'cs-tripos-demo-2025-databases',
    courseId: DEMO_COURSE.id,
    name: 'Databases',
    lectureIds: ['cs-tripos-demo-2025-databases-01'],
  },
];
